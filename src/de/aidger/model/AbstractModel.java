 ...
 */
public abstract class AbstractModel<T> extends Observable implements IAdoHiveModel<T> {
    ...
    protected IAdoHiveManager getManager()
    {
        ...
        try {
            m = AdoHiveController.getInstance().getClass().getMethod("get" +
                    classname + "Manager");
            return (IAdoHiveManager) m.invoke(
