...
import de.aidger.utils.pdf.BudgetReportConverter;
import de.aidger.utils.reports.BalanceHelper;
import de.aidger.view.UI;
import de.aidger.view.tabs.BudgetViewerTab;

/**
 * This action exports a budget report.
 * 
 * @author aidGer Team
 */
public class BudgetExportAction extends AbstractAction {

    /**
     * Initializes the action.
     */
    public BudgetExportAction() {
    ...
    public void actionPerformed(ActionEvent arg0) {
        BudgetViewerTab tab = (BudgetViewerTab) UI.getInstance()
            .getCurrentTab();
        if (new BalanceHelper().getSemesters().size() > 0) {
            ...
            new BudgetReportConverter(file, tab.getBudgetFilter());
        }
