 ...
 *
 */
class AnsiInternalFinancialManager extends JdbcInternalFinancialManager {
	 ...
	 */
	public AnsiInternalFinancialManager(Connection con, SqlDialect dialect) throws AdoHiveException {
		super(con, dialect);
