...
Die Software soll übersichtlich und einfach zu bedienen sein, um eine
möglichst geringe Einarbeitungszeit zu ermöglichen. Es soll auf möglichst
vielen Betriebssystemen lauffähig sein.
...
\section{Annahmen und Abhängigkeiten\label{sec:Annahmen-und-Abh=0000E4ngigkeiten}}

Bei der Spezifikation wurde von folgenden externen Einflussfaktoren
ausgegangen:
\begin{itemize}
\item Da von unbezahlten Hilfskräften ausgeführt, besteht kein Geldmangel. 
\item Das System soll eine möglichst lange Lebensdauer haben und muss deshalb
möglichst flexibel sein. 
\item Es stehen genügend Filmbesitzer als Tester zur Verfügung 
\end{itemize}

\section{Entwurfseinschränkungen\label{sec:Entwurfseinschr=0000E4nkungen}}
...
\section{Externe Schnittstellen\label{sec:Externe-Schnittstellen}}

Der ,,aidGer{}`` benötigt eine Schnittstelle zur verwendeten Datenbank.
Diese wird durch die Bibliothek AdoHive zur Verfügung gestellt. Zudem
wird eine Verbindung mit dem bereits vorhandenen Ticketsystem benötigt.
