...
\item Content-Frame wird mit ,,Hinzufügen{}``-Dialog ersetzt
\item Benutzer gibt die erforderlichen Daten ein
\item Benutzer klickt auf den Button ,,OK{}``
\item Content-Frame wird mit dem vorherigen Zustand ersetzt
\end{enumerate}
\tabularnewline
\hline 
...
\item Content-Frame wird durch den ,,Bearbeiten{}``-Dialog ersetzt
...
\item Das ,,Bestätigungs{}``-Popup wird geöffnet
\item Benutzer klickt auf den Button ,,Ja{}``
\item Popup wird geschlossen
\end{enumerate}
\tabularnewline
\hline 
...
\item Content-Frame wechselt in den ,,Vorgänge anzeigen{}``-Dialog
\item Es werden alle Vorgänge zu der ausgewählten Beschäftigung aufgelistet
\item Benutzer klickt auf den ,,Zurück{}``-Button
\item Content-Frame wird mit dem vorherigen Zustand wieder ausgetauscht
\end{enumerate}
\end{enumerate}
\tabularnewline
\hline 
...
\item Content-Frame wird mit dem ,,Tätigkeitsnachweis{}``-Dialog ausgewechselt
\item Es werden alle Veranstaltungen zu der ausgewählten Hilfskraft in einer
Tabelle aufgelistet
\item Benutzer klickt auf den Button ,,Zurück{}``
\item Content-Frame wird mit dem vorherigen Zustand ausgewechselt
\end{enumerate}
\tabularnewline
\hline 
...
\item Benutzer wählt eine Hilfskraft aus
\item Benutzer klickt auf den Button ,,Vorgänge anzeigen{}``
\item Content-Frame wird mit dem ,,Vorgänge anzeigen{}``-Dialog ausgetauscht
\item Es werden alle Vorgänge zu der gewählten Hilfskraft dargestellt
\item Benutzer klickt auf den Button ,,Zurück{}``
\item Content-Frame wird mit dem vorherigen Zustand ausgetauscht
\end{enumerate}
...
\item Content-Frame wird mit dem ,,Hilfskräfte anzeigen{}``-Dialog ersetzt
\item Es werden alle Hilfskräfte zu der Veranstaltung und zusätzlich das
verbrauchte und eingeplante Budget angezeigt
\item Benutzer klickt auf den Button ,,Zurück{}``
\item Content-Frame wird mit dem vorherigen Zustand ausgetauscht
\end{enumerate}
\end{enumerate}
...
\item Tätigkeitsnachweis wird generiert
\item Tätigkeitsnachweis wird je nach Einstellung geöffnet
\end{enumerate}
\tabularnewline
\hline 
...
\item Content Frame wird mit dem ,,Beschäftigung buchen{}``-Dialog ausgetauscht
...
\begin{enumerate}
\item Der Fehler wird in der Hinweisleiste angezeigt
\item Das inkorrekte Feld wird markiert
\end{enumerate}
...
\item Content-Frame wechselt in den Zustand vor der Buchung der Beschäftigung
\end{enumerate}
\tabularnewline
\hline 
...
\item Content-Frame wird durch ,,Vorgang hinzufügen{}``-Dialog ersetzt
\item Der Bearbeiter des Vorgangs wird automatisch durch den Namen des Benutzers
eingetragen
...
\item Benutzer klickt auf den Button ,,Hinzufügen{}``
\item Content-Frame geht in den vorherigen Zustand über
\end{enumerate}
\tabularnewline
\hline 
...
\item Benutzer wählt einen Vorgang aus
\item Benutzer klickt auf den Button ,,Löschen{}``
\item Das ,,Bestätigen{}``-Popup öffnet sich
\item Benutzer klickt auf den Button ,,Ja{}``
\item Popup wird geschlossen
\end{enumerate}
\tabularnewline
...
\item Die Tabelle wird mit jeder Eingabe aktualisiert
\end{enumerate}
\tabularnewline
\hline 
...
\item Es wird kein Eintrag gefunden

\begin{enumerate}
\item In der Hinweisleiste wird angezeigt, dass es keine Treffer gibt.
\end{enumerate}
\end{enumerate}
\tabularnewline
\hline 
...
\item In der Hinweisleiste wird angezeigt, dass es keine Unstimmigkeiten
gibt
\end{enumerate}
\tabularnewline
\hline 
...
\begin{enumerate}
\item In der Hinweisleiste wird angezeigt, dass es Unstimmigkeiten bei einer
Hilfskraft gibt
\item Die Hilfskraft wird markiert
\end{enumerate}
\end{enumerate}
\tabularnewline
\hline 
...
\item Benutzer klickt auf den Button ,,Generieren{}``
\item Bericht wird generiert
\item Bericht wird je nach Einstellungen geöffnet
\end{enumerate}
\tabularnewline
\hline 
...
\item Use-Case-Diagram erstellt
\end{itemize}
