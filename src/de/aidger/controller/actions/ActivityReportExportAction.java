...
import de.aidger.utils.pdf.ActivityReportConverter;
import de.aidger.view.UI;
import de.aidger.view.tabs.ActivityReportViewerTab;

/**
 * This action exports an activity report.
 * 
 * @author aidGer Team
 */
@SuppressWarnings("serial")
public class ActivityReportExportAction extends AbstractAction {

    /**
     * Initializes the action.
     */
    public ActivityReportExportAction() {
    ...
    public void actionPerformed(ActionEvent e) {
        ActivityReportViewerTab tab = (ActivityReportViewerTab) UI
        ...
        new ActivityReportConverter(file, tab.getRows(), tab.getAssistantName());
    }
}
