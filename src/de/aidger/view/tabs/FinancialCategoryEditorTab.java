...
public class FinancialCategoryEditorTab extends MasterDataEditorTab {

    /**
     * Constructs a new financial category editor tab.
     */
    public FinancialCategoryEditorTab() {
        super(MasterDataType.FinancialCategory);
    }
