...
gebuchten und eingeplanten HKS an, wobei falsch gebuchte Veranstaltungen
...
\item siehe 1a)
\end{enumerate}
\item Benutzer gibt einen inkorrekten Zeitraum ein
...
\hline 
\textbf{Alternativer Ablauf:} & \begin{enumerate}
\item Benutzer gibt ein falsches Datum ein

\begin{enumerate}
\item Fehler wird in der Hinweisleiste angezeigt
\item Benutzer korrigiert die falschen Daten
\end{enumerate}
\item Benutzer klickt auf den Button ,,Abbrechen{}``
...
\item Benutzer klickt auf den Button ,,Suchen{}``
\end{enumerate}
\tabularnewline
\hline 
