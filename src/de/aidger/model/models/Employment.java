...
/**
 * Represents a single entry in the employment column of the database.
 * Contains functions to retrieve and change the data in the database.
 *
 * @author aidGer Team
 */
public class Employment extends AbstractModel implements IEmployment {
	 ...
	 *
	 * @param cost The cost unit of the contract
	 */
	@Override
	 ...
	 *
	 * @param fonds The fonds of the employment
	 */
	@Override
	 ...
	 *
	 * @param hours The hours worked during the employment
	 */
	@Override
	 ...
	 *
	 * @param month The month of the employment
	 */
	@Override
	 ...
	 *
	 * @param rem The remarks regarding the employment
	 */
	@Override
	 ...
	 *
	 * @param year The year of the employment
	 */
	@Override
	...
	/**
	 * Set the unique id of the employment.
	 *
	 * <b>!!! THIS IS FOR INTERNAL ADOHIVE USAGE ONLY !!!</b>
	 *
	 * @param id The unique id of the employment
	 */
	@Override
