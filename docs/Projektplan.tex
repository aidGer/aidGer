...
\item Erfassung aller Geschäftsvorgänge, die getätigt werden (z.B. Arbeitsverträge)
\item Möglichkeit zur Auflistung aller Vorgänge mittels der Protokoll-Funktion
\item Kompatibilität zur Datenbankschnittstelle AdoHive
\item Export von erweiterten PDF-Berichten
\item Möglichkeit zur Ausgabe von täglichen Mitteilungen (z.B. zur Vorgangsübersicht)
\item Komfortable Ünterstützung des Users bei der Dateneingabe
\item Unterstützung für paralleles Arbeiten
\item Möglichkeit zur Massenerfassung von Daten
\item Anonymisierung von alten Datensätzen aufgrund des Datenschutzes
\item Möglichkeit zum Drucken der Daten
\item Benutzerhilfe / Benutzerhandbuch
...
E-Mail: \url{gildeipp@studi.informatik.uni-stuttgart.de}\tabularnewline
\noalign{\vskip0.4cm}
\textbf{Mitarbeiter 1: } & Herr Phlipp Pirrung\\
E-Mail: \url{pirrunpp@studi.informatik.uni-stuttgart.de}\tabularnewline
\noalign{\vskip0.4cm}
\textbf{Mitarbeiter 2:} & Herr Christian Buchgraber\\
E-Mail: \url{buchgrcn@studi.informatik.uni-stuttgart.de}\tabularnewline
\noalign{\vskip0.4cm}
\end{tabular}
...
\begin{center}
\includegraphics[width=1\textwidth]{gannt}
\par\end{center}
